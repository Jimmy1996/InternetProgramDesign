 ...
 * @author C507
 */
public class TCPClientJFrame1 extends javax.swing.JFrame {
    private TCPClient ec;
    public TCPClientJFrame1() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
            ...
            try{
               ...
               Thread receiver=new Thread(){//用一个线程专门来接收信息。 服务器返回多条信息时，才能成功接收
                @Override
                public void run(){
                  String msg=null;
                  while((msg=ec.receive())!=null){
                   ...
                   display.setCaretPosition(length);//滚动条总是移动到最后一行信息.
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TCPClientJFrame1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TCPClientJFrame1().setVisible(true);
